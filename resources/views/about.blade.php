	...
	<div class="about-image bg-grey">
		...
		<div class="container content-lg">
			<div class="title-v1">
				...
				<p><strong>Visión.</strong> Ser una empresa de expansión, proyección, búsqueda y consolidación de la <strong>excelencia</strong>. Posicionada entre las lideres a nivel nacional e internacional, en la prestación de nuestros servicios profesionales a <strong>nuestros clientes</strong>, conforme al objeto de la misma. </p>
				<p><strong>Misión.</strong> Brindar a <strong>nuestros clientes</strong> un servicio de Consultoría Gerencial, Administrativa, Contable, de Gestión Empresarial con una vanguardia de <strong>excelencia</strong>, en el acompañamiento de las tomas de decisiones Gerenciales en la búsqueda de un plan de proyección con visión a futuro, con una generación de valor tanto en materia de Inversión, Financiera, como Operacional y seguimiento en cada una de las estrategias de cada Organización.</p>
			</div>

			<div class="title-v1">
				<h2>Nuestros Principios y Valores</h2>
				<p>Nuestra empresa esta inspirada en <strong>DIOS NUESTRO SEÑOR</strong>. Creemos en el trabajo como instrumento dignificador del ser humano; respetamos a las personas, valoramos la honestidad, la responsabilidad y la lealtad.  La integridad, la equidad y la discreción son referencias permanentes en nuestro quehacer diario. Nos esforzamos en dar nuestro aporte para que la humanidad alcance niveles dignos de calidad de vida.</p>
				<p>Nuestros Principios y Valores están basados en Nuestro Señor Jesucristo los cuales son:<br>✓ Confidencialidad<br>✓ Honestidad<br>✓ Confianza<br>✓ Respeto<br>✓ Integridad</p>
			</div>
